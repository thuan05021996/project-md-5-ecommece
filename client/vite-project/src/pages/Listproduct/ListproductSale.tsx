...
export default function ListproductSale() {
    ...
    const listproducts = async () => {
        try {
          const res = await publicAxios.get( `/api/v1/project-details?oderby=sale&min=${valueinput}&max=${valueinput1}`);
      ...
      >
        ...
        <div style={{ width: "80%", backgroundColor: "white" }}>
          <div style={{ display: "flex" ,padding : '10px',gap : '10px',borderBottom : '3px solid rgb(248,248,252)'}}>
            ...
            style={{border : '2px solid rgb(0,101,69)',padding : '10px',borderRadius : '3px',color : 'rgb(0,101,69)'}}>Khuyến mãi tốt nhất</div>
            <div
